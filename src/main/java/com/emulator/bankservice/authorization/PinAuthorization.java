...
@Slf4j
@Component
public class PinAuthorization implements UserAuthorization {
    private static final AuthMethod AUTH_METHOD = AuthMethod.PIN;
    ...
    public boolean authenticate(String actualCredential, UserEntity userEntity) {
        ...
        return actualCredential.equals(userEntity.getPIN());
    }
}
